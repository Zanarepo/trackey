        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="p-2 border rounded dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-600 view-mode-selector"
            >
          ...
          {viewMode === 'list' && (
            <input
              ...
              className="p-2 border rounded w-full sm:w-64 text-white dark:bg-gray-800"
            />
          )}
        </div>
        <button
          onClick={() => setShowAdd(true)}
          className="flex items-center gap-2 px-4 py-2 text-sm sm:text-base bg-indigo-600 text-white rounded-md hover:bg-indigo-700 w-full sm:w-auto new-sale-button"
        >
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 p-2 border rounded dark:bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-indigo-600"
                />
                <button
                  type="button"
                       ...
                       <button
                        onClick={() => {
                          ...
                          setSaleForm({
                            ...
                            isQuantityManual: false,
                            isPriceManual: true, // Set to true to preserve existing unit_price
